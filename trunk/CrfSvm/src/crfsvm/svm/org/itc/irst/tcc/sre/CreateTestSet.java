...
public class CreateTestSet
{
	 ...
	 * Logger instance named <code>CreateTestSet</code>.
	 */
	static Logger logger = Logger.getLogger(CreateTestSet.class.getName()); 
...
/*
		...
		{
			logger.error("cannot find dir " + outputDir);
			System.exit(-1);
		}
		*/
	...
	//
	private FeatureIndex[] readFeatureIndex(int subspaceCount) throws IOException
	{
