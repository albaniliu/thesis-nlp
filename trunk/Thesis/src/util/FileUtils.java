...
public class FileUtils {
    ...
    public static void createTrainSet(Document doc, int B, int bagSize) throws FileNotFoundException{
    ...
    public static void createTestSet(Document doc, int number) throws FileNotFoundException {
...
//    }// end convert2IOB method
    ...
    public static void mergeFile(String dirPath, String mergePath) throws FileNotFoundException {
     ...
     */
    // <editor-fold defaultstate="collapsed" desc="mergeFile method">
    public static void mergeFile(String dirPath, String mergePath, FilenameFilter nameFilter) throws FileNotFoundException {
        File dir = new File(dirPath);
